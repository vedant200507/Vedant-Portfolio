...
const Hero = () => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      id="home"
      className='min-h-screen flex items-center pt-20 pb-16 bg-gradient-to-r from-[#lala] via-[#2d2d2d] to-[#1a1a1a]'
      >
        <div className='container mx-auto px-6 flex flex-col md:flex-row items-center justify-between'>
            <div className='md:w-1/2 mb-10 md:mb-0'>
              <h1 className='text-4xl md:text-6xl font-bold mb-4'>
                Hello, I'm <span className='text-purple'>Vedant Kolapkar</span>
              </h1>
              ...
              <p className='text-lg text-gray-300 mb-8'>I create stunning web experiences with modern technologies
                 and innovative design. Let's build something amazing together!</p>
